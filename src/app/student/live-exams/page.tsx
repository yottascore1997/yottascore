              ...
              return (
                ...
                >
                  ...
                  <div className="text-sm text-gray-500 mb-4 flex flex-wrap gap-2">
                    <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">{exam.subject}</span>
                    <span className="px-2 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-medium">{exam.standard}</span>
                    <span className="px-2 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium">{exam.totalMarks || 5} Questions</span>
                  </div>
            ...
            <div className="p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 border border-gray-200">
                  <h4 className="text-lg font-semibold text-gray-900 mb-4">Subject Information</h4>
