...
const sidebarLinks = [
  ...
  { 
    name: 'Battle Quiz Amounts', 
    href: '/admin/battle-quiz/amounts', 
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  { 
    ...
    href: '/admin/question-of-the-day', 
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  { 
    name: 'PYQ (Previous Year)', 
    href: '/admin/pyq-exams', 
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
      </svg>
          ...
          {sidebarLinks.map((link) => {
            ...
            return (
              <Link
                key={link.name}
                href={link.href}
                className={`group flex items-center px-3 py-3 rounded-xl text-sm font-medium transition-all duration-200 relative overflow-hidden ${
                  isActive 
              ...
              >
                ...
                {/* Hover effect */}
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-purple-600/10 opacity-0 group-hover:opacity-100 transition-opacity duration-200 rounded-xl"></div>
              </Link>
            );
          })}
        </nav>
        ...
        <div className="p-4 border-t border-gray-200/50 flex-shrink-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-800">Mayur</p>
